...
export class BlinnPhongMaterial extends BaseMaterial {
  ...
  get baseTexture(): SamplerTexture2D {
    return <SamplerTexture2D>this.shaderData.getTexture(BlinnPhongMaterial._baseTextureProp);
  }
  ...
  get specularTexture(): SamplerTexture2D {
    return <SamplerTexture2D>this.shaderData.getTexture(BlinnPhongMaterial._specularTextureProp);
  }
  ...
  get emissiveTexture(): SamplerTexture2D {
    return <SamplerTexture2D>this.shaderData.getTexture(BlinnPhongMaterial._emissiveTextureProp);
  }
  ...
  get normalTexture(): SamplerTexture2D {
    return <SamplerTexture2D>this.shaderData.getTexture(BlinnPhongMaterial._normalTextureProp);
  }
